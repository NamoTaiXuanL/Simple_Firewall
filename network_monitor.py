...
class NetworkMonitorGUI:
    ...
    def create_listening_tab(self):
        ...
        for col in columns:
            self.listening_tree.heading(col, text=col, command=lambda c=col: self.sort_by_column(c))
    ...
    def update_process_network(self):
        ...
        try:
            ...
            # 排序
            network_info.sort(key=lambda x: x.get('total_connections', 0), reverse=True)
